<?php
/**
 * OTP Login Form Widget for Elementor
 */
...
class WP_OTP_Login_Login_Form_Widget extends \Elementor\Widget_Base {
    
    public function get_name() {
        return 'wp_otp_login_form';
    }
    
    public function get_title() {
        return __('OTP Login Form', 'wp-otp-login');
    }
    ...
    public function get_keywords() {
        return ['login', 'otp', 'sms', 'authentication'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('ورود با شماره موبایل', 'wp-otp-login'),
        ...
        $this->add_control(
            'verify_button_text',
            [
                'label' => __('Verify & Login Button Text', 'wp-otp-login'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('ورود به سایت', 'wp-otp-login'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Redirect After Login', 'wp-otp-login'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wp-otp-login-form' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wp-otp-login-form',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .wp-otp-login-form' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        wp_localize_script('wp-otp-login-frontend', 'wpOtpLogin', [
            ...
            'messages' => [
                ...
                'loginSuccess' => __('ورود موفقیت‌آمیز بود', 'wp-otp-login'),
        ...
        <div class="wp-otp-login-form" data-widget-type="login">
            ...
            <form id="wp-otp-login-form-<?php echo esc_attr($this->get_id()); ?>">
                <!-- Phone Number Step -->
                ...
                <div class="wp-otp-step wp-otp-step-verify" style="display: none;">
                    <div class="wp-otp-input-group">
                        ...
                        <button type="submit" 
                                ...
                                data-widget-id="<?php echo esc_attr($this->get_id()); ?>"
                                data-redirect-url="<?php echo esc_url($settings['redirect_after_login']['url']); ?>">
